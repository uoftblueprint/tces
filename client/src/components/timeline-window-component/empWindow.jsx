      ...
      <Box paddingTop={2} paddingBottom={2} paddingLeft={2}>
        <Grid container direction="row" alignItems="center">
          ...
          <CardContent>
            ...
            >
              <Button fullWidth startIcon={<AddIcon />} sx = {{ backgroundColor: "#3568E5" }} >Add New Entry</Button>
        ...
        '& .MuiTabs-flexContainer': { display: 'flex', justifyContent: 'center', width: "100%", gap: -2 }, 
