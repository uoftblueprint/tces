...
function EmployerInformationCard({ employer }) {
  ...
  const [employerPhoneNumber, setEmployerPhoneNumber] = useState(employer.phone_number);
  ...
  return (
    <Card 
      ...
      <BoxRowComponent leftSide="Phone Number" rightSide={employerPhoneNumber ? <a href={`tel:${employerPhoneNumber}`}>{employerPhoneNumber}</a> : ""} />
