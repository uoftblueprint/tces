...
function EmployerContactComponent ({ ...props }) {
    return (
        <CardComponent title={props.title} dateAdded={props.dateAdded} body={props.body} imageUrl={"/img/timelineIconContact.svg"} />
    );
};

EmployerContactComponent.propTypes = {
...
export default EmployerContactComponent;
